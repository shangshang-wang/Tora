...
_ALL_RECIPES = [
    ...
    Recipe(
        ...
        configs=[
            ...
            Config(name="qwen2_5/1.5B_dora_grpo", file_path="qwen2_5/1.5B_dora_grpo.yaml"),
            Config(name="qwen2_5/3B_dora_grpo", file_path="qwen2_5/3B_dora_grpo.yaml"),
            Config(name="qwen2_5/7B_dora_grpo", file_path="qwen2_5/7B_dora_grpo.yaml"),
        ],
        supports_distributed=True,
    ),
    Recipe(
